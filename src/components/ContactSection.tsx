            ...
            <div className="grid grid-cols-1 gap-6 h-full">
              <div className="glass-card p-8 bg-primary-50">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start">
                    <div className="flex-shrink-0 h-10 w-10 rounded-full bg-primary-100 flex items-center justify-center mr-4">
                      <svg className="h-6 w-6 text-primary-600" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    ...
                    <div>
                      ...
                      <a href="https://wa.me/254706274350" target="_blank" rel="noopener noreferrer" className="text-primary-600 hover:text-primary-800 transition-colors">
                        (+254) 0706274350
                      </a>
                    </div>
                  </div>
