...
const NewsletterSignup = () => {
  ...
  return (
    <div className="glass-card p-6 rounded-xl shadow-lg">
      <h3 className="text-xl font-bold text-primary-800 mb-3">Subscribe to Our Newsletter</h3>
      <p className="text-gray-600 mb-4">Stay updated with our latest promotions and water services.</p>
