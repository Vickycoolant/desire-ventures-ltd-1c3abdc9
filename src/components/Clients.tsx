      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mb-16 reveal reveal-delay-2">
          {clients.map((client) => (
            <div 
              key={client.id} 
              className="bg-white/10 backdrop-blur-sm rounded-xl overflow-hidden transition-all duration-500 border border-white/10 h-[300px] perspective"
            >
              <div className="relative w-full h-full transform-style-3d transition-transform duration-700 ease-in-out hover:rotate-y-180">
                {/* Front */}
                ...
                {/* Back */}
                <div 
                  className="absolute inset-0 bg-primary-700 p-6 flex flex-col justify-center items-center backface-hidden rotate-y-180"
                >
